...
variable "github_org" {
  description = "GitHub organization or username hosting this repository."
  type        = string
}
...
variable "github_repo" {
  ...
  type        = string
  default     = "cloudops-self-healing"
}

variable "create_github_oidc_provider" {
  description = "Set to false if your AWS account already has a GitHub OIDC provider registered (only one is allowed per account)."
  type        = bool
  default     = true
}
