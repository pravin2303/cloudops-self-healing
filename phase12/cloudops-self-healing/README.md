...
- [x] Phase 5 — ECR
- [x] Phase 6 — ALB + Target Group
- [x] Phase 7 — Compute (Launch Template)
- [x] Phase 8 — Auto Scaling Group
- [x] Phase 9 — CloudWatch monitoring
- [x] Phase 10 — Failure simulation
- [x] Phase 11 — CI pipeline
- [x] Phase 12 — CD pipeline (OIDC)
